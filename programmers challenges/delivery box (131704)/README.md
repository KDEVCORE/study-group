# [택배상자#131704](https://school.programmers.co.kr/learn/courses/30/lessons/131704)
...
## 접근 방법
임시로 저장할 택배상자 순서 Stack 선언, Queue에 n(order length)까지의 숫자 초기화 후 반복문 실행.

반복문을 Array index로 판별하여 동기화해가며 순서 판별

> Queue 사용하지 않고 배열 index 사용하여 동기화 판별하니 통과, Queue 사용할 경우 테스트케이스 6~10 통과 못함.